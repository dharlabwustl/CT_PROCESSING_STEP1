...
/Stroke_CT_Processing/stroke_ct_processing_1.sh ${working_dir} ${output_directory}
/Stroke_CT_Processing/step4_bet.sh ${output_directory}
/Stroke_CT_Processing/stroke_ct_processing_2.sh ${output_directory} ${output_directory}
######################################################################################################################
